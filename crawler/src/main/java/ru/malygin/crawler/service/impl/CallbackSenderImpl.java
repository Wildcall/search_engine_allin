...
import ru.malygin.crawler.config.ResourceConfig;
import ru.malygin.crawler.config.WebClientConfiguration;
...
import ru.malygin.crawler.service.CallbackSender;
...
public class CallbackSenderImpl implements CallbackSender {
    ...
    private void send(ResourceCallback resourceCallback) {
        ...
        ResourceConfig.ResourceParam resourceParam = resourceConfig
                .getResource(type);
